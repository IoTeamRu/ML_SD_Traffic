...
def get_review(
    ...
    for chunked_diff in chunked_diff_list:
        ...
        template = """Act as an experienced Python developer. Check the provided code and find all the problems,
        vulnerabilities, errors, arcitectural misconceptions and all you suggest important. Provide a concise 
        summary of all abovementioned found in the code, describing its characteristics, location, and potential
        effects on the overall functionality and performance of the application. Present the potential issues 
        and errors first, following by the most important findings, in your summary. 
